...
def sprite_system(world, surface, render_alpha, draw_debug=False):
    ...
    try:
        ...
        record_counter_for_world(
            world,
            "render.sprites_considered",
            sprites_considered,
        )
        record_counter_for_world(
            world,
            "render.sprites_with_transform",
            sprites_with_transform,
        )
        record_counter_for_world(
            world,
            "render.sprites_drawn",
            len(draw_list),
        )
        record_counter_for_world(
            world,
            "render.sprites_scaled",
            sprites_scaled,
        )
        record_counter_for_world(
            world,
            "render.sprite_debug_entities",
            len(debug_draw_list),
        )


@profiled("render.tiles")
def tile_render_system(world, surface, render_alpha=0.0):
    ...
    tiles_drawn = 0
    tiles_scaled = 0
    static_collision_markers_drawn = 0
    debug_tile_highlights_drawn = 0
    ...
    try:
        for y, row in enumerate(world.tilemap):
            for x, tile in enumerate(row):
                ...
                if (x, y) in world.static_collision_tiles:
                    ...
                    static_collision_markers_drawn += 1
        ...
        for highlight in world.debug_tile_highlights:
            ...
            debug_tile_highlights_drawn += 1

    finally:
        record_counter_for_world(
            world,
            "render.tiles_considered",
            tiles_considered,
        )
        record_counter_for_world(
            world,
        ...
        record_counter_for_world(
            world,
            "render.static_collision_markers",
            static_collision_markers_drawn,
        )
        record_counter_for_world(
            world,
            "render.debug_tile_highlights",
            debug_tile_highlights_drawn,
        )
